...
class ControladorProduto:
    def __init__(self, controlador_sistema):
        ...
        quali = Qualificador("peso", "1 kilo")
        novo1 = Produto("bala", "doce", "55", supermer,cate,[quali],self.__usuario)
        prec = 10.00
        novo1.add_preco(prec)
        self.adicionar_registro(novo1, prec, "inclusão")
        self.__lista_produtos.append(novo1)
    ...
    def relatorio(self):
        ...
        lista_opcoes = {1: self.produtos_por_supermercado, 2: self.evolucao_precos, 3: self.listar_precos_de_um_produto, 0: self.abre_tela}
        while True:
    ...
    def excluir_preco(self):
        ...
        if (produto is not None):
            ...
            preco_excluir = self.__tela_produto.pega_float("Digite o preço para excluir: ") # pegar com duas casas decimais
